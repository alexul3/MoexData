...
# ------------------------------------------------------------
COMPANY_TO_TICKER = {
    # Банки и финансы (по данным МосБиржи, доля сектора превышает 27%[reference:1])
    "сбербанк": "SBER",
    "сбер": "SBER",
    "втб": "VTBR",
    ...
    # Металлы и горная добыча (включая компании из топ-100 по версии РБК[reference:2])
    ...
    # Телекоммуникации и IT (включая Яндекс и Ozon из топа Мосбиржи[reference:3][reference:4])
    "мтс": "MTSS",
    "ростелеком": "RTKM",
    "яндекс": "YNDX",
    "вк": "VKCO",
    ...
    # Розничная торговля (включая X5 Group и Магнит[reference:5][reference:6])
    "магнит": "MGNT",
    "х5": "X5",
    ...
    # Транспорт (включая Аэрофлот и Совкомфлот из топа РБК[reference:7][reference:8])
    "аэрофлот": "AFLT",
    "совкомфлот": "FLOT",
    "нмтп": "NMTP",
    "глобалтранс": "GLTR",
    ...
    # Химия и удобрения (включая ФосАгро и Акрон[reference:9][reference:10])
    "фосагро": "PHOR",
    "акрон": "AKRN",
    "уралкалий": "URKA",
    "куйбышевазот": "KAZT",

    # Девелопмент и строительство (включая Самолет из топа РБК[reference:11])
    "пик": "PIKK",
    "группа лср": "LSRG",
    "эталон": "ETLN",
    "самолет": "SMLT",
